...
Development is tracked through [GitHub milestones](https://github.com/fighters-legacy/fa-content/milestones),
...
**The working plugin is the primary output.** fa-content implements the fighters-legacy
...
| RGBA8 → PNG | **stb_image_write.h** (public domain) | Single header; KTX2/libktx deferred ([#41](https://github.com/fighters-legacy/fa-content/issues/41)) |
| PCM → OGG Vorbis | **libogg + libvorbis/vorbisenc** (BSD-3) | The validator requires `OggS` and no credible single-header *encoder* exists; verify minivorbis first ([#40](https://github.com/fighters-legacy/fa-content/issues/40)) |
...
- **License boundary and the open question:** fighters-codex is MIT; one-way consumption
  ...
  positioned fa-content as a paid, non-GPL plugin (possible via `IContentPack.h`'s GPL
